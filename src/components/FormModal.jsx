...
const FormModal = ({
    ...
    const handleSubmit = async (e) => {
        ...
        if(missing.length >0) {
            setError(`${missing.map(f => f.lable).join(", ")}  ${missing.length > 1 ? "are" : "is"  }`);
            return 
        } 
